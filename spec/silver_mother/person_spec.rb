  ...
  describe Person do
    ...
    context 'with all data' do
      it 'pulls raw persons with #call' do
        ...
        expect(persons_api.persons_raw[0].parsed_response).to eq expected_raw_person_data
      end

      it 'extracts persons data with #persons' do
        expected_persons = JSON.parse(fixture('dummy_persons.json'), object_class: OpenStruct).objects
